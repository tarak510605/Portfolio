...
const Projects: React.FC = () => {
  ...
  const projects = [
    ...
    {
      title: 'CodeSnippet Search - Smart Code Discovery Platform',
      description:
      'A powerful code snippet search platform that enables developers to quickly find, store, and share reusable code snippets. Features advanced search functionality, syntax highlighting, and organized categorization for efficient code management.',
      image:
      ...
      liveUrl: 'https://github.com/tarak510605/CodeSnippet-Search', 
      githubUrl: 'https://github.com/tarak510605/CodeSnippet-Search', 
      category: 'Web App',
    },
    {
      title: 'Restaurant Ordering System',
      description:
      'A comprehensive restaurant ordering system featuring online menu browsing, cart management, order placement, and real-time order tracking. Includes admin dashboard for menu management and order processing.',
      image:
      'https://images.pexels.com/photos/262978/pexels-photo-262978.jpeg?auto=compress&cs=tinysrgb&w=600',
      technologies: ['React', 'Node.js', 'Express.js', 'MongoDB', 'Tailwind CSS'],
      liveUrl: 'https://github.com/tarak510605/restaurant-ordering-system', 
      githubUrl: 'https://github.com/tarak510605/restaurant-ordering-system', 
      category: 'Web App',
    },
    {
